...
Components: Application\Plugins\Security; Source: {#BinLibDir}\Harpy.Basic{#AppMajorMinorVersion}\keyRing.one.eagle; DestDir: {app}\lib\Harpy.Basic{#AppMajorMinorVersion}; Flags: restartreplace uninsrestartdelete
Components: Application\Plugins\Security; Source: {#BinLibDir}\Harpy.Basic{#AppMajorMinorVersion}\keyRing.one.eagle.harpy; DestDir: {app}\lib\Harpy.Basic{#AppMajorMinorVersion}; Flags: restartreplace uninsrestartdelete
