...
namespace Eagle._Components.Private
{
    ...
    internal static class BuiltIns
    {
        ...
        private static CommandFlags[] commandFlags = {
            /* After */ CommandFlags.Safe | CommandFlags.Standard,
            /* Append */ CommandFlags.Safe | CommandFlags.Standard,
            /* Apply */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.SecuritySdk,
            /* Array */ CommandFlags.Safe | CommandFlags.Standard,
            /* Base64 */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Bgerror */ CommandFlags.Safe | CommandFlags.Standard,
            /* Break */ CommandFlags.Safe | CommandFlags.Standard,
            /* Callback */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Catch */ CommandFlags.Safe | CommandFlags.Standard,
            /* Cd */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Clock */ CommandFlags.Unsafe | CommandFlags.Standard
#if NATIVE && WINDOWS
            | CommandFlags.NativeCode,
#else
            ,
#endif
            /* Close */ CommandFlags.Safe | CommandFlags.Standard,
            /* Concat */ CommandFlags.Safe | CommandFlags.Standard,
            /* Continue */ CommandFlags.Safe | CommandFlags.Standard,
            /* Debug */ CommandFlags.Unsafe | CommandFlags.NonStandard | CommandFlags.Diagnostic,
            /* Do */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Downlevel */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Eof */ CommandFlags.Safe | CommandFlags.Standard,
            /* Error */ CommandFlags.Safe | CommandFlags.Standard,
            /* Eval */ CommandFlags.Safe | CommandFlags.Standard,
            /* Exec */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Exit */ CommandFlags.Safe | CommandFlags.Standard,
            /* Expr */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Fblocked */ CommandFlags.Safe | CommandFlags.Standard,
            /* Fconfigure */ CommandFlags.Safe | CommandFlags.Standard,
            /* Fcopy */ CommandFlags.Safe | CommandFlags.Standard,
            /* Flush */ CommandFlags.Safe | CommandFlags.Standard,
            /* For */ CommandFlags.Safe | CommandFlags.Standard,
            /* Foreach */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.SecuritySdk,
            /* Format */ CommandFlags.Safe | CommandFlags.Standard,
            /* Fpclassify */ CommandFlags.Safe | CommandFlags.Standard,
            /* Getf */ CommandFlags.Unsafe | CommandFlags.NonStandard | CommandFlags.Obsolete | CommandFlags.Diagnostic,
            /* Gets */ CommandFlags.Safe | CommandFlags.Standard,
            /* Glob */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Global */ CommandFlags.Safe | CommandFlags.Standard,
            /* Host */ CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* If */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize | CommandFlags.SecuritySdk,
            /* Incr */ CommandFlags.Safe | CommandFlags.Standard,
            /* Info */ CommandFlags.Unsafe | CommandFlags.Standard
#if NATIVE
            | CommandFlags.NativeCode
#endif
            | CommandFlags.Initialize,
            /* Interp */ CommandFlags.Unsafe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Invoke */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Join */ CommandFlags.Safe | CommandFlags.Standard,
            /* Kill */ CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* Lappend */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lassign */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lget */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Library */ CommandFlags.NativeCode | CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* Lindex */ CommandFlags.Safe | CommandFlags.Standard,
            /* Linsert */ CommandFlags.Safe | CommandFlags.Standard,
            /* List */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.SecuritySdk | CommandFlags.LicenseSdk,
            /* Llength */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Lmap */ CommandFlags.Safe | CommandFlags.Standard,
            /* Load */ CommandFlags.Unsafe | CommandFlags.Standard | CommandFlags.SecuritySdk | CommandFlags.LicenseSdk,
            /* Lrange */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lremove */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Lrepeat */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lreplace */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lreverse */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lsearch */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lset */ CommandFlags.Safe | CommandFlags.Standard,
            /* Lsort */ CommandFlags.Safe | CommandFlags.Standard,
            /* Namespace1 */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Namespace2 */ CommandFlags.NoAdd | CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Nop */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Nproc */ CommandFlags.Safe | CommandFlags.Standard,
            /* Object */ CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* Open */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Package */ CommandFlags.Unsafe | CommandFlags.Standard | CommandFlags.Initialize | CommandFlags.SecuritySdk | CommandFlags.LicenseSdk,
            /* Parse */ CommandFlags.Safe | CommandFlags.NonStandard | CommandFlags.Diagnostic,
            /* Pid */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Proc */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Puts */ CommandFlags.Safe | CommandFlags.Standard,
            /* Pwd */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Read */ CommandFlags.Safe | CommandFlags.Standard,
            /* Regexp */ CommandFlags.Safe | CommandFlags.Standard,
            /* Regsub */ CommandFlags.Safe | CommandFlags.Standard,
            /* Rename */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.SecuritySdk,
            /* Return */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize,
            /* Scope */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Seek */ CommandFlags.Safe | CommandFlags.Standard,
            /* Set */ CommandFlags.Safe | CommandFlags.Standard,
            /* Setf */ CommandFlags.Unsafe | CommandFlags.NonStandard | CommandFlags.Obsolete | CommandFlags.Diagnostic,
            /* Socket */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Source */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Split */ CommandFlags.Safe | CommandFlags.Standard,
            /* Sql */ CommandFlags.Unsafe | CommandFlags.NonStandard
#if NATIVE && WINDOWS
            | CommandFlags.NativeCode,
#else
            ,
#endif
            /* Subst */ CommandFlags.Safe | CommandFlags.Standard,
            /* Switch */ CommandFlags.Safe | CommandFlags.Standard,
            /* Tcl */ CommandFlags.NativeCode | CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* Tell */ CommandFlags.Safe | CommandFlags.Standard,
            /* Test1 */ CommandFlags.Safe | CommandFlags.NonStandard | CommandFlags.Diagnostic,
            /* Test2 */ CommandFlags.Safe | CommandFlags.NonStandard | CommandFlags.Diagnostic
#if NATIVE && WINDOWS
            | CommandFlags.NativeCode,
#else
            ,
#endif
            /* Throw */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Time */ CommandFlags.Safe | CommandFlags.Standard
#if NATIVE && WINDOWS
            | CommandFlags.NativeCode,
#else
            ,
#endif
            /* Truncate */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Try */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* Unload */ CommandFlags.Unsafe | CommandFlags.Standard,
            /* Unset */ CommandFlags.Safe | CommandFlags.Standard,
            /* Unsetf */ CommandFlags.Unsafe | CommandFlags.NonStandard | CommandFlags.Obsolete | CommandFlags.Diagnostic,
            /* Update */ CommandFlags.Safe | CommandFlags.Standard,
            /* Uplevel */ CommandFlags.Safe | CommandFlags.Standard,
            /* Upvar */ CommandFlags.Safe | CommandFlags.Standard,
            /* Vwait */ CommandFlags.Safe | CommandFlags.Standard,
            /* While */ CommandFlags.Safe | CommandFlags.Standard,
            /* Xml */ CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* _Encoding */ CommandFlags.Safe | CommandFlags.Standard,
            /* _File */ CommandFlags.Unsafe | CommandFlags.Standard
#if NATIVE && WINDOWS
            | CommandFlags.NativeCode
#endif
            | CommandFlags.SecuritySdk,
            /* _Guid */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* _Hash */ CommandFlags.Safe | CommandFlags.NonStandard,
            /* _String */ CommandFlags.Safe | CommandFlags.Standard | CommandFlags.Initialize | CommandFlags.SecuritySdk,
            /* _Uri */ CommandFlags.Unsafe | CommandFlags.NonStandard,
            /* _Variable */ CommandFlags.Safe | CommandFlags.Standard,
            /* _Version */ CommandFlags.Unsafe | CommandFlags.NonStandard | CommandFlags.Diagnostic
        };
        ...
        private static FunctionFlags[] functionFlags = {
            /* Abs */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Acos */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Asin */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Atan */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Atan2 */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Bool */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Ceil */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Cos */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Cosh */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Decimal */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Double */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* E */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Epsilon */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Exp */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Flags */ FunctionFlags.Unsafe | FunctionFlags.NonStandard,
            /* Floor */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Fmod */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Hypot */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Int */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Isfinite */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Isinf */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Isnan */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Isnormal */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Issubnormal */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Isunordered */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* List */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Log */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Log10 */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Log2 */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Logx */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Max */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Min */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Nop */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Pi */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Pow */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Rand */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Randstr */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Round */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Round2 */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Round3 */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Sign */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Sin */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Sinh */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Sqrt */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Srand */ FunctionFlags.Unsafe | FunctionFlags.Standard,
            /* Tan */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Tanh */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* Truncate */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Typeof */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* Wide */ FunctionFlags.Safe | FunctionFlags.Standard,
            /* _DateTime */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* _Random */ FunctionFlags.Safe | FunctionFlags.NonStandard,
            /* _TimeSpan */ FunctionFlags.Safe | FunctionFlags.NonStandard
        };
        ...
        private static OperatorFlags[] operatorFlags = {
            /* BitwiseAnd */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* BitwiseEqv */ OperatorFlags.NonStandard | OperatorFlags.Bitwise,
            /* BitwiseImp */ OperatorFlags.NonStandard | OperatorFlags.Bitwise,
            /* BitwiseNot */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* BitwiseOr */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* BitwiseXor */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* Divide */ OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* Equal */ OperatorFlags.Standard | OperatorFlags.Relational | OperatorFlags.Initialize | OperatorFlags.SecuritySdk,
            /* Exponent */ OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* GreaterThan */ OperatorFlags.Standard | OperatorFlags.Relational | OperatorFlags.Initialize,
            /* GreaterThanOrEqualTo */ OperatorFlags.Standard | OperatorFlags.Relational,
            /* LeftRotate */ OperatorFlags.NonStandard | OperatorFlags.Bitwise,
            /* LeftShift */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* LessThan */ OperatorFlags.Standard | OperatorFlags.Relational,
            /* LessThanOrEqualTo */ OperatorFlags.Standard | OperatorFlags.Relational,
            /* ListIn */ OperatorFlags.Standard | OperatorFlags.List,
            /* ListNotIn */ OperatorFlags.Standard | OperatorFlags.List,
            /* LogicalAnd */ OperatorFlags.Special | OperatorFlags.Standard | OperatorFlags.Logical | OperatorFlags.Initialize,
            /* LogicalEqv */ OperatorFlags.NonStandard | OperatorFlags.Logical,
            /* LogicalImp */ OperatorFlags.Special | OperatorFlags.NonStandard | OperatorFlags.Logical,
            /* LogicalNot */ OperatorFlags.Standard | OperatorFlags.Logical | OperatorFlags.Initialize | OperatorFlags.SecuritySdk,
            /* LogicalOr */ OperatorFlags.Special | OperatorFlags.Standard | OperatorFlags.Logical,
            /* LogicalXor */ OperatorFlags.NonStandard | OperatorFlags.Logical,
            /* Minus */ OperatorFlags.Special | OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* Modulus */ OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* Multiply */ OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* NotEqual */ OperatorFlags.Standard | OperatorFlags.Relational,
            /* Plus */ OperatorFlags.Special | OperatorFlags.Standard | OperatorFlags.Arithmetic,
            /* Question */ OperatorFlags.Special | OperatorFlags.Direct | OperatorFlags.Standard | OperatorFlags.Conditional | OperatorFlags.Initialize,
            /* RightRotate */ OperatorFlags.NonStandard | OperatorFlags.Bitwise,
            /* RightShift */ OperatorFlags.Standard | OperatorFlags.Bitwise,
            /* StringEqual */ OperatorFlags.Standard | OperatorFlags.String,
            /* StringGreaterThan */ OperatorFlags.Standard | OperatorFlags.String,
            /* StringGreaterThanOrEqualTo */ OperatorFlags.Standard | OperatorFlags.String,
            /* StringLessThan */ OperatorFlags.Standard | OperatorFlags.String,
            /* StringLessThanOrEqualTo */ OperatorFlags.Standard | OperatorFlags.String,
            /* StringNotEqual */ OperatorFlags.Standard | OperatorFlags.String,
            /* VariableAssignment */ OperatorFlags.NonStandard | OperatorFlags.Assignment
        };
