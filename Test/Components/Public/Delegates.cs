...
namespace Eagle._Components.Public.Delegates
{
    ...
    /// <summary>
    /// This delegate represents a callback used to clear the set of test
    /// items.  It accepts no arguments and returns no value.
    /// </summary>
    [ObjectId("bdea0daf-f0e8-43cd-b775-c53972cea292")]
    public delegate void ClearTestItemsDelegate();

    /// <summary>
    /// This delegate represents a callback used to add a test item.
    /// </summary>
    /// <param name="item">
    /// The test item to be added.
    /// </param>
    /// <returns>
    /// An integer result produced by the callback (e.g. the index of the
    /// newly added item).
    /// </returns>
    ...
    /// <summary>
    /// This delegate represents a callback used to clear the status text.  It
    ...
    /// <summary>
    /// This delegate represents a callback used to append to the status text.
    /// </summary>
    /// <param name="text">
    /// The status text to be appended.
    /// </param>
    /// <param name="newLine">
    /// Non-zero to append a line terminator after the text; otherwise, zero.
    /// </param>
    ...
    /// <summary>
    /// This delegate represents a callback used to set the current progress
    /// value.
    /// </summary>
    /// <param name="value">
    /// The new progress value to be set.
    /// </param>
    [ObjectId("d90b0d10-c066-4a73-897e-488d926452cb")]
    public delegate void SetProgressValueDelegate(int value);

    /// <summary>
    /// This delegate represents a callback used to evaluate a script.
    /// </summary>
    /// <param name="text">
    /// The script text to be evaluated.
    /// </param>
    /// <param name="synchronizedResult">
    /// The result instance used to communicate the value or error produced by
    ...
    /// <summary>
    /// This delegate represents a callback invoked when a script has
    /// completed.
    /// </summary>
    /// <param name="text">
    ...
    /// </param>
    /// <param name="result">
    /// The result produced by evaluating the script.
    /// </param>
    ...
    /// <summary>
    /// This delegate represents a callback invoked when a script has been
    /// canceled.  It accepts no arguments and returns no value.
    /// </summary>
